        ...
        <nav className="flex items-center gap-6">
          ...
          {user && (
            <button
              ...
              className="relative text-gray-500 hover:text-red-400 transition-colors"
            >
              <FavoriteBorderIcon />
            </button>
          )}
          ...
          {user && (
            <button
              ...
              className="relative text-gray-500 hover:text-violet-600 transition-colors"
            >
          ...
          {user ? (
            <div className="relative" onMouseEnter={() => setMenuOpen(true)} onMouseLeave={() => setMenuOpen(false)}>
              <button className="flex items-center gap-2 bg-violet-50 hover:bg-violet-100 text-violet-700 px-3 py-1.5 rounded-lg transition-colors">
                ...
                <span className="text-sm font-medium">{user.role === "admin" ? "Админ" : user.firstname}</span>
              </button>
              {menuOpen && (
